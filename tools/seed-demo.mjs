...
await mk(
  ...
  { slug: "kremen", tags: ["оперативники", "разлом", "пропавшие"], eventAt: "2031-04-12", eventEpoch: "Разлом" },
);
...
await mk(
  ...
  { slug: "sova", tags: ["оперативники", "связь"], eventAt: "2029-08-02", eventEpoch: "Восхождение" },
);
...
await mk(
  ...
  { slug: "vein", tags: ["аналитики"], eventAt: "2033-01-19", eventEpoch: "Пепел" },
);
...
await mk(
  ...
  { slug: "apollo", tags: ["операции", "восхождение"], eventAt: "2029-08-02", eventEpoch: "Восхождение" },
);
...
await mk(
  ...
  { slug: "eden-op", tags: ["операции", "расселение", "разлом"], eventAt: "2030-03-11", eventEpoch: "Разлом" },
);
...
await mk(
  ...
  { slug: "sad", tags: ["расселение", "разлом"], eventAt: "2031-09-12", eventEpoch: "Разлом" },
);
...
await mk(
  ...
  { slug: "noon", tags: ["операции"], eventAt: "2031-06-03", eventEpoch: "Разлом" },
);
...
await mk(
  ...
  { slug: "cape", tags: ["места", "восхождение"], eventAt: "2027-05-30", eventEpoch: "Восхождение" },
);
...
await mk(
  ...
  { slug: "voskhod", tags: ["организации"], eventAt: "2026-11-04", eventEpoch: "" },
);
...
await mk(
  ...
  { slug: "kollegia", tags: ["организации"], eventAt: "2032-02-08", eventEpoch: "Пепел" },
);
...
await mk(
  ...
  { slug: "izdelie-7", tags: ["техника"], eventAt: "2028-06-15", eventEpoch: "Восхождение" },
);
