...
// «Голый» инпут cmdk без обвязки (иконки/InputGroup) — для полностью
// кастомной строки ввода. Сохраняет фильтрацию cmdk.
function CommandInputBare({
  ...
  return (
    <CommandPrimitive.Input
      data-slot="command-input-bare"
      className={cn("bg-transparent outline-hidden", className)}
      {...props}
    />
  )
}
